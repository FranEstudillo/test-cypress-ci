describe("Procesos de venta en la página web de ODM", () => {
  ...
  //FECHAS DE VIAJE
  let fechaSalidaViaje = "16/01/2025";
  let fechaRegresoViaje = "20/01/2025";
  //ORIGEN Y DESTINO
  let origenViaje = "MEX";
  let destinoViaje = "MTY";

  it("CP 1 - Venta de viaje sencillo con un solo pasajero", function () {
  ...
  it("un pasajero sencillo", function () {
    ...
    //FECHAS DE VIAJE
    const fechaSalida = "16/01/2025";
    const fechaRegreso = "20/01/2025";
